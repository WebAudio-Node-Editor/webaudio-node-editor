...
export class EditorDelayNode extends Classic.Node<
    { signal: Classic.Socket; delayTime: Classic.Socket },
    { signal: Classic.Socket },
    { maxDelay: LabeledInputControl }
> {
    width = 180
    height = 240
    constructor(
    ...
    data(inputs: { signal?: AudioNode[]; delayTime?: AudioNode[] }): {
        signal: AudioNode
    } {
        ...
        if (inputs.delayTime && inputs.delayTime.length > 0) {
            ...
            delayNode.delayTime.setValueAtTime(
                (delayControl as LabeledInputControl).value || 0,
    ...
    serialize() {
        return {
            delay: (this.inputs.delayTime?.control as LabeledInputControl)
                .value,
